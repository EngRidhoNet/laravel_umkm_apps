    ...
    <div class="py-5 my-auto" style="background: linear-gradient(to right, #0DBDE5, #2DB08B)">
        <div class="container py-5 my-auto" style="min-height: 10vh; display: flex; flex-direction: column; justify-content: center;">
            ...
            <div class="row justify-content-center text-center"> <!-- Tambahkan justify-content-center -->
                ...
                <div class="col-md-2 animate-from-left">
                    <div class="card shadow-sm p-3 mb-5 bg-white rounded-lg" style="height: 150px; border-radius: 10px;">
                        <div href="{{route('umkm')}}">
                            <img src="{{asset('images/agrikultur.png')}}" class="card-img-top mx-auto" alt="Galeri UMKM" style="width: 50%;">
                            <div class="card-body">
                ...
                <div class="col-md-2 animate-from-right">
                    <div class="card shadow-sm p-3 mb-5 bg-white rounded-lg" style="height: 150px; border-radius: 10px;">
                        <img src="{{asset('images/akuntansi.png')}}" class="card-img-top mx-auto" alt="Konsultasi UMKM" style="width: 50%;">
                        <div class="card-body">
                ...
                <div class="col-md-2 animate-from-left">
                    <div class="card shadow-sm p-3 mb-5 bg-white rounded-lg" style="height: 150px; border-radius: 10px;">
                        <img src="{{asset('images/edukasi.png')}}" class="card-img-top mx-auto" alt="Informasi Bisnis" style="width: 50%;">
                        <div class="card-body">
                ...
                <div class="col-md-2 animate-from-right">
                    <div class="card shadow-sm p-3 mb-5 bg-white rounded-lg" style="height: 150px; border-radius: 10px;">
                        <img src="{{asset('images/finance.png')}}" class="card-img-top mx-auto" alt="Chat" style="width: 50%;">
                        <div class="card-body">
                ...
                <div class="col-md-2 animate-from-left">
                    <div class="card shadow-sm p-3 mb-5 bg-white rounded-lg" style="height: 150px; border-radius: 10px;">
                        <img src="{{asset('images/tekonolgi.png')}}" class="card-img-top mx-auto" alt="Blog" style="width: 50%;">
                        <div class="card-body">
            ...
            <div class="row justify-content-center text-center"> <!-- Tambahkan justify-content-center -->
                ...
                <div class="col-md-2 animate-from-left">
                    <div class="card shadow-sm p-3 mb-5 bg-white rounded-lg" style="height: 150px; border-radius: 10px;">
                        <img src="{{asset('images/kesehatan.png')}}" class="card-img-top mx-auto" alt="Blog" style="width: 50%;">
                        <div class="card-body">
                ...
                <div class="col-md-2 animate-from-right">
                    <div class="card shadow-sm p-3 mb-5 bg-white rounded-lg" style="height: 150px; border-radius: 10px;">
                        <img src="{{asset('images/kreativ.png')}}" class="card-img-top mx-auto" alt="Blog" style="width: 50%;">
                        <div class="card-body">
                ...
                <div class="col-md-2 animate-from-left">
                    <div class="card shadow-sm p-3 mb-5 bg-white rounded-lg" style="height: 150px; border-radius: 10px;">
                        <img src="{{asset('images/lingkungan.png')}}" class="card-img-top mx-auto" alt="Blog" style="width: 50%;">
                        <div class="card-body">
                ...
                <div class="col-md-2 animate-from-right">
                    <div class="card shadow-sm p-3 mb-5 bg-white rounded-lg" style="height: 150px; border-radius: 10px;">
                        <img src="{{asset('images/sosial.png')}}" class="card-img-top mx-auto" alt="Blog" style="width: 50%;">
                        <div class="card-body">
        ...
        <div class="product-section shadow-sm">
            <div class="container">
                <div class="row">
                    <!-- Start Column 1 -->
                    <div class="col-md-12 col-lg-3 mb-5 mb-lg-0">
                        <h2 class="mb-4 section-title">Lainya</h2>
                        <p class="mb-4">Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit. Aliquam vulputate velit imperdiet dolor tempor tristique. </p>
                        <p><a href="shop.html" class="btn">Explore</a></p>
                    </div>
                    <!-- End Column 1 -->
